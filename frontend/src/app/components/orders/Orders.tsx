...
export function Orders() {
  const { orders, updateOrderStatus, cancelOrder, updateOrderComments, loading } = useData();
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">Gestión de pedidos y seguimiento de envíos</p>
      </div>
