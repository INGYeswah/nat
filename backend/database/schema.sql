...
--   8. Nombres de tabla en MAYÚSCULAS para coincidir con el backend
--      (Linux MySQL es case-sensitive: USUARIO ≠ usuario)
-- --------------------------------------------------------
...
-- FIX #6: se agrega 1 registro para poder probar POST /api/ventas y /api/pedidos
-- =============================================================================
